                  ...
                  <Tooltip.Provider delayDuration={120} skipDelayDuration={80}>
                    <div class="toolbar-collaborator-stack" role="group" aria-label="Document collaborators">
                      {documentCollaborators.map((collaborator) => {
                        const label = collaborator.isAuthor
                          ? `Owner: ${collaborator.login}`
                          : `Invited editor: ${collaborator.login}`;
                        return (
                          <Tooltip.Root key={collaborator.login}>
                            <Tooltip.Trigger class="toolbar-collaborator-trigger" aria-label={label}>
                              <img
                            ...
                            <Tooltip.Portal>
                              <Tooltip.Content class="toolbar-tooltip-content" side="bottom" sideOffset={8}>
                                {label}
                                <Tooltip.Arrow class="toolbar-tooltip-arrow" width={10} height={5} />
                              </Tooltip.Content>
                            </Tooltip.Portal>
                          </Tooltip.Root>
                        );
