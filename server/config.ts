...
export const UPSTREAM_PROXY_MAX_CONCURRENT_WEBCONTAINER_ANON = parsePositiveIntEnv(
...
export const CONTENT_SECURITY_POLICY =
  "default-src 'self'; script-src 'self' 'sha256-wBdtWdXsHnAU2DdByySW4LlXFAScrBvmBgkXtydwJdg=' 'wasm-unsafe-eval' https://*.webcontainer-api.io https://*.staticblitz.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; connect-src 'self' https://api.github.com https://gist.githubusercontent.com http://127.0.0.1:8788 http://localhost:8788 https://*.webcontainer-api.io https://*.staticblitz.com wss://*.webcontainer-api.io; font-src 'self' data: blob: https:; worker-src 'self' blob:; frame-src 'self' https://stackblitz.com https://*.webcontainer-api.io https://*.staticblitz.com";
